    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          ...
          <TabsContent value="all" className="mt-2 space-y-0">
            <CrawlResultsTable
              results={getFilteredResults('all')}
              isLoading={isLoading}
          ...
          <TabsContent value="completed" className="mt-2 space-y-0">
            <CrawlResultsTable
              results={getFilteredResults('completed')}
              isLoading={isLoading}
              selectedIds={selectedIds}
              setSelectedIds={setSelectedIds}
              sortField={sortField}
          ...
          <TabsContent value="running" className="mt-2 space-y-0">
            <CrawlResultsTable
              results={getFilteredResults('running')}
              isLoading={isLoading}
              selectedIds={selectedIds}
              setSelectedIds={setSelectedIds}
              sortField={sortField}
          ...
          <TabsContent value="queued" className="mt-2 space-y-0">
            <CrawlResultsTable
              results={getFilteredResults('queued')}
              isLoading={isLoading}
              selectedIds={selectedIds}
              setSelectedIds={setSelectedIds}
              sortField={sortField}
          ...
          <TabsContent value="error" className="mt-2 space-y-0">
            <CrawlResultsTable
              results={getFilteredResults('error')}
              isLoading={isLoading}
              selectedIds={selectedIds}
              setSelectedIds={setSelectedIds}
              sortField={sortField}
